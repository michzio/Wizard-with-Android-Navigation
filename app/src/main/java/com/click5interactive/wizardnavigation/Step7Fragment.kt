...
class Step7Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        submitButton.setOnClickListener {
            NavHostFragment.findNavController(this).navigate(WIZARD_ACTION)
        }
    }
    ...
    companion object {
        ...
        val WIZARD_DESTINATION = R.id.step7Fragment
        val WIZARD_ACTION = R.id.action_step7Fragment_to_confirmFragment
        val STEP_NAME = "Step7"
        val MODEL = StepModel(WIZARD_DESTINATION, WIZARD_ACTION, STEP_NAME)
    }
}
